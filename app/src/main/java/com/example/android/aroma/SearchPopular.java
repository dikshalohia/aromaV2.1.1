...
public class SearchPopular extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_search_popular);
        mQueue = Volley.newRequestQueue(this);
        foodList = new ArrayList<>();
        //load menu
        recyclerMenu = (RecyclerView)findViewById(R.id.recycler_food_top);
    ...
    private void jsonParse() {
        String base_url ="http://aroma-env.wv5ap2cp4n.us-west-1.elasticbeanstalk.com/recipes?search=popular";
                ...
                new Response.Listener<JSONObject>()
                {
                    ...
                    public void onResponse(JSONObject response)
                    {
                        ...
                        try {
                            ...
                            foodListAdapter = new FoodListAdapter(SearchPopular.this, foodList);
                            recyclerMenu.setAdapter(foodListAdapter);
                            foodListAdapter.setOnItemClickListener(SearchPopular.this);
